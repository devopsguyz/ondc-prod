...
public class EncryptDecrypt {
    ...
    /**
     * This method is encrypt key by clientPublicKey,clientPrivateKey,proteanPrivateKey,proteanPublicKey and value. 
     * @param request It is a client and protean key details.
     * @return Its returns encrypted key based on clientPublicKey,clientPrivateKey,proteanPrivateKey,proteanPublicKey and value.
     */
	public String encrypt(RequestEncDecryptData request) {
		...
		try {
			...
			System.out.println("Challange :"+b64Encryped1);
			return b64Encryped1;
		} catch (Exception e) {
    ...
    /**
     * This method decrypt keys by clientPublicKey,clientPrivateKey,proteanPrivateKey,proteanPublicKey and value.
     * @param request It is a client and protean key details.
     * @return Its returns decrypted key based on clientPublicKey,clientPrivateKey,proteanPrivateKey,proteanPublicKey and value.
     */
	public String decrypt(RequestEncDecryptData request) {
		...
		try {
			...
			SecretKey key1 = atServer1.generateSecret(secretKey); // derive secret at server 1.
																	// "TlsPremasterSecret" is the algorithm for
System.out.println("skey:"+ key1.getAlgorithm());
    ...
    /**
     * This method gets public key by algo and  jceBytes and throws exception.
     * @param algo It is a Sting.
     * @param jceBytes It is a byte.
     * @return Its returns public key based on the algo and  jceBytes. 
     * @throws Exception Thrown key exception.
     */
    ...
    /**
     * This method gets private key by String algo and byte jceBytes and throws exception for key.
    ...
    /**
     * This method two parties generating key pair on their own servers. 
     * @throws Exception Thrown exception for key pair.
     */
