...
public class APIAspSecret {
	...
	public static String getGstAspSecret(String urlAspSecretGst, Gst gst) throws Exception {
		...
		try {
			...
			url = new URL(urlAspSecretGst);
			log.info("URL " + urlAspSecretGst);
			...
			line = in.readLine();
			logMsg = line;
			gst.responseAspSecret = new Gson().fromJson(line, ResponseAspSecret.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			getGstAspSecret("https://test.nsdlgsp.co.in/NGCSGSP/callApi/commonapi/v0.2/authenticate", gst);
			log.info(gst.responseAspSecret.auth_token);
		} catch (Exception e) {
