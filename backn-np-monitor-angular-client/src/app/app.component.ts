...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this._title.setTitle(this.coreConfig.app.appTitle);
     //this._authenticationService.loginKeyClock();
    this._authenticationService.configure();
    ...
    this.coreConfig.app.appLogoImage = environment.logoURL;
    this.coreConfig.app.appName = environment.uiRole =='domain'? environment.applicationDomainName: environment.applicationName;
    this.coreConfig.app.appTitle = environment.appTitle;
  }
