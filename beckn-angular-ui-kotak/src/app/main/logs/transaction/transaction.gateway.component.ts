...
@Component({
  selector: "app-transaction-gateway",
  templateUrl: "./transaction.gateway.component.html",
  styleUrls: ["./transaction.gateway.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class TransactionGatewayComponent implements OnInit {
  @Input()
  ...
  loadRows(item) {
   ...
   if(!rowsBuyerToGateway){
    ...
    this.rowsrowsGatewayToBuyer=[...this.rowsrowsGatewayToBuyer];
