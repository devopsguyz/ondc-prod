...
@Table(name = "api_audit_archvl_tmp", indexes = { @Index(name = "created_on_index", columnList = "created_on"),
...
public class ApiAuditMumbaiArchalTmpEntity extends ApiAuditParentEntity {
	@Id
	@Column(name = "id")
	private String id;
