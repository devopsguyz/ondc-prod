...
public class GraphAnalysisDehliArchalTmp extends GraphAnalysis {
	...
	public GraphAnalysisDehliArchalTmp() {

	}

	public GraphAnalysisDehliArchalTmp(GraphAnalysis graph) {
		this.db=graph.getDb();
		this.id=graph.getId();
