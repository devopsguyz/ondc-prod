package com.nsdl.beckn.klm.utl;
...
public class Constants {
	...
	public static Integer PAGE_SIZE_TRANSACTION = 100;
	...
	public static String Gateway_to_Adapter = "Gateway_to_Adapter";
	public static String Adapter_to_Gateway = "Adapter_to_Gateway";
	public static String Adapter_to_Buyer = "Adapter_to_Buyer";
...
//	public static String ACK_TO_BUYER = "ACK_TO_BUYER";
	...
	public static String REQUEST_TO_GATEWAY = "REQUEST_TO_GATEWAY";
	public static String ACK_BY_GATEWAY = "ACK_BY_GATEWAY";
	
	public static String ACK_TO_GATEWAY = "ACK_TO_GATEWAY";
	public static String NACK_TO_GATEWAY="NACK_TO_GATEWAY";
	public static String RESPONSE_BY_GATEWAY = "RESPONSE_BY_GATEWAY";
	...
	public static String col_ack_json = "ack_json";
